...
{
	#region CryptoServerChannelSink
	internal class CryptoServerChannelSink : BaseChannelObjectWithProperties, IServerChannelSink
	{
		...
		#region constructor
		public CryptoServerChannelSink() : base(){}
	...
	#region CryptoServerChannelSinkProvider
	internal class CryptoServerChannelSinkProvider : IServerChannelSinkProvider
	{
		#region private field
		...
		public IServerChannelSink CreateSink(IChannelReceiver channel)
		{
			...
			return new CryptoServerChannelSink(nextSink);
		}
